...
const AdminAddUser = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      {/* Header Section */}
      <div className="bg-gradient-to-r from-[#260058] to-[#3e0091] text-white px-6 py-8 rounded-b-3xl shadow-lg mb-8">
        <h1 className="text-3xl font-bold">Add Employee</h1>
        <p className="mt-2 text-purple-200">Create a new employee account</p>
      </div>
        ...
        <div className="bg-white rounded-2xl shadow-md p-8 mb-8">
          <form onSubmit={handleSubmit} className="space-y-6 max-w-3xl mx-auto">
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 text-sm border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#260058]"
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  onChange={handleChange}
                  className="w-full px-4 py-2.5 text-sm border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#260058] bg-white"
                  required
                >
            ...
            <div className="flex justify-end pt-6">
              <button 
                type="submit" 
                className="px-6 py-2.5 text-sm font-medium text-white bg-[#260058] hover:bg-[#3e0091] rounded-xl transition-colors shadow-sm"
              >
                Add Employee
              </button>
            </div>
